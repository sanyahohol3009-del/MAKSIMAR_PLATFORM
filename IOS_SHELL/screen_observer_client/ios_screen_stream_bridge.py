...
class IOSScreenStreamBridge:
    ...
    def __post_init__(self) -> None:
        ...
        if self.child_control_enabled:
            raise ValueError("normal iOS screen stream cannot enable child control")

    @classmethod
    def default(cls, *, device_id: str, session_id: str) -> "IOSScreenStreamBridge":
        return cls(
            device_id=device_id,
    ...
    def build_frame_reference(
        ...
        *,
        ...
        return IOSScreenFrameReference(
            session_id=self.session_id,
            device_id=self.device_id,
            frame_ref=frame_ref,
