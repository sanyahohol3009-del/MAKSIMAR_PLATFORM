# iOS P2P Node Adapter — Phase 2 / Batch 2.8

This directory is an iOS shell-side P2P node adapter surface.

It is not a real iOS P2P runtime.
It does not perform peer discovery.
It does not open sockets.
It does not open ports.
It does not call iOS system network APIs.
