...
_ALLOWED_STORAGE_SCOPES = ("ios_app_sandbox", "ios_keychain_reference", "ios_private_container")
_REF_PREFIXES = ("ios-secure-ref://", "secure-ref://")
...
class IOSSecureLocalStore:
    ...
    def __post_init__(self) -> None:
        for field_name in ("local_store_id", "device_id", "app_id", "ios_bundle_id"):
    ...
    def default_secure_store(
        ...
        *,
        ...
        return cls(
            ...
            storage_ref=f"ios-secure-ref://{device_id}/app-memory/{local_store_id}",
