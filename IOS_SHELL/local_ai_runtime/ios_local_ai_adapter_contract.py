...
class IOSLocalAiAdapterContract:
    contract_id: str
    platform: str
...
def build_ios_local_ai_adapter_contract() -> IOSLocalAiAdapterContract:
    return IOSLocalAiAdapterContract(
        contract_id="ios_local_ai_adapter_contract_v0_1",
        platform="ios",
