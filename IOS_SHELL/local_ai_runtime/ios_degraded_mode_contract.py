...
def build_ios_degraded_mode_contract() -> IOSDegradedModeContract:
    return IOSDegradedModeContract(
        contract_id="ios_degraded_mode_contract_v0_1",
        platform="ios",
