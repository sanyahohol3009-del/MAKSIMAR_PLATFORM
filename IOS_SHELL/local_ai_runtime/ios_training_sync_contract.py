...
def build_ios_training_sync_contract() -> IOSTrainingSyncContract:
    return IOSTrainingSyncContract(
        contract_id="ios_training_sync_contract_v0_1",
        platform="ios",
