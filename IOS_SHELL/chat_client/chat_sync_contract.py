...
class IOSChatSyncContract:
    """iOS chat sync contract.

    Contract only. It does not call iOS APIs, start background tasks, open
    sockets, sync with a server, or mutate canonical truth.
    """
    ...
    background_task_start_allowed: bool
    ...
    def __post_init__(self) -> None:
        ...
        if self.background_task_start_allowed:
            raise ValueError("background_task_start_allowed must be False")
