...
_ALLOWED_STORAGE_SCOPES = ("ios_private_reference", "quarantine_reference", "server_reference")
...
class IOSFileAttachmentBridgeContract:
    """iOS file attachment bridge.

    Contract only. It does not read files, write files, open iOS document
    pickers, upload/download data, or call iOS file APIs.
    """
    ...
    ios_file_api_call_allowed: bool
    ...
    def __post_init__(self) -> None:
        ...
        if self.ios_file_api_call_allowed:
            raise ValueError("ios_file_api_call_allowed must be False")
