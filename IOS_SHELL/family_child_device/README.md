# iOS Family Child Device Bridge

This iOS shell layer describes the family/child managed device bridge.
...
This layer is a shell bridge / policy projection layer for BATCH 4.5.
