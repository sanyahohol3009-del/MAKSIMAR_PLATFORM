...
class IosVpnSyncContract:
    """iOS VPN sync contract.
    ...
    def __post_init__(self) -> None:
        if self.schema_version != "ios_vpn_sync_contract.v1":
            raise ValueError("schema_version must be ios_vpn_sync_contract.v1")
        if self.sync_id != "ios_vpn_sync_disabled_default":
            raise ValueError("sync_id must be ios_vpn_sync_disabled_default")
...
def build_ios_vpn_sync_contract() -> IosVpnSyncContract:
    return IosVpnSyncContract(
        schema_version="ios_vpn_sync_contract.v1",
        sync_id="ios_vpn_sync_disabled_default",
        platform="ios",
        ...
        reason_codes=("ios_vpn_sync_contract_read_only_until_network_policy_gate",),
    )
