...
def build_txt_adapter_capability() -> ArchiveAdapterCapability:
    return ArchiveAdapterCapability(
        adapter_id="HADAPTER-TXT-001",
        source_type="txt",
...
def build_txt_adapter_protocol() -> ArchiveAdapterProtocolContract:
    return ArchiveAdapterProtocolContract(
        adapter_name="txt_adapter",
