...
JARVIS_LIVE_FULL_ROADMAP_BATCHES: tuple[JarvisLiveRoadmapBatch, ...] = (
    ...
    JarvisLiveRoadmapBatch(
        ...
        expected_files=(
            "MAKSIMAR_SERVER/AI_ORCHESTRATION/jarvis_live_text_loop_adapter_contract.py",
            "MAKSIMAR_SERVER/AI_ORCHESTRATION/jarvis_live_project_context_reader_contract.py",
            "MAKSIMAR_SERVER/AI_ORCHESTRATION/jarvis_live_tts_smoke_contract.py",
            "tests/ai_orchestration/test_jarvis_live_text_loop_adapter_contract_smoke.py",
            "tests/ai_orchestration/test_jarvis_live_project_context_reader_contract_smoke.py",
            "tests/ai_orchestration/test_jarvis_live_tts_smoke_contract_smoke.py",
        ),
        target_tests=(
            "tests/ai_orchestration/test_jarvis_live_text_loop_adapter_contract_smoke.py",
            "tests/ai_orchestration/test_jarvis_live_project_context_reader_contract_smoke.py",
        ...
        pc_control_allowed=False,
        depends_on=("JL-10",),
        status_rule="first_voice_smoke_metadata_only_no_runtime_no_pc_control",
    ),
    JarvisLiveRoadmapBatch(
        batch_id="JL-12",
        ...
        expected_files=(
            "MAKSIMAR_CORE_LIB/real_voice_runtime/push_to_talk_stt_contract.py",
            "MAKSIMAR_CORE_LIB/real_voice_runtime/stt_runtime_candidate_contract.py",
            "MAKSIMAR_SERVER/VOICE_ROUTING/stt_transcript_read_model.py",
            "tests/real_voice_runtime/test_push_to_talk_stt_contract_smoke.py",
            "tests/voice_routing/test_stt_transcript_read_model_smoke.py",
        ),
        target_tests=(
            "tests/real_voice_runtime/test_push_to_talk_stt_contract_smoke.py",
            "tests/voice_routing/test_stt_transcript_read_model_smoke.py",
        ...
        pc_control_allowed=False,
        depends_on=("JL-11",),
        status_rule="push_to_talk_contract_only_no_runtime_no_wake_word_no_control",
    ),
    JarvisLiveRoadmapBatch(
        batch_id="JL-13",
        ...
        expected_files=(
            ...
            "tests/mobile_screen_observer/test_desktop_screen_observer_contract_smoke.py",
            "tests/mobile_screen_observer/test_desktop_screen_summary_read_model_smoke.py",
        ),
        target_tests=(
            "tests/mobile_screen_observer/test_desktop_screen_observer_contract_smoke.py",
            "tests/mobile_screen_observer/test_desktop_screen_summary_read_model_smoke.py",
        ...
        pc_control_allowed=False,
        depends_on=("JL-12",),
        status_rule="screen_summary_read_only_no_runtime_no_app_control",
    ),
    JarvisLiveRoadmapBatch(
        batch_id="JL-14",
        ...
        expected_files=(
            ...
            "MAKSIMAR_SERVER/WORKFLOW_AUTOMATION_RUNTIME/jarvis_pc_action_approval_binding.py",
            "WORKFLOW_ENGINE/config/jarvis_pc_action_allowlist.yaml",
            "tests/workflow_engine/test_jarvis_pc_action_adapter_contract_smoke.py",
            "tests/workflow_engine/test_jarvis_pc_action_approval_binding_smoke.py",
            "tests/workflow_engine/test_jarvis_pc_action_allowlist_contract_smoke.py",
            "tests/proposal_audit/test_jarvis_pc_action_audit_binding_smoke.py",
        ),
        target_tests=(
            "tests/workflow_engine/test_jarvis_pc_action_adapter_contract_smoke.py",
            "tests/workflow_engine/test_jarvis_pc_action_approval_binding_smoke.py",
        ...
        pc_control_allowed=False,
        depends_on=("JL-13",),
        status_rule="controlled_pc_action_candidate_requires_allowlist_approval_audit_no_runtime",
    ),
)
