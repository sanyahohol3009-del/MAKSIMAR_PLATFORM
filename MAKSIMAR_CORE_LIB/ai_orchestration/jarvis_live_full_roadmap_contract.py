...
JARVIS_LIVE_FULL_ROADMAP_BATCHES: tuple[JarvisLiveRoadmapBatch, ...] = (
    ...
    JarvisLiveRoadmapBatch(
        ...
        expected_files=(
            "MAKSIMAR_CORE_LIB/ai_orchestration/jarvis_live_model_profile_registry_contract.py",
            "MAKSIMAR_CORE_LIB/ai_orchestration/jarvis_live_model_resource_requirements_contract.py",
            "tests/jarvis_live/test_jarvis_live_model_profile_registry_smoke.py",
        ),
        target_tests=("tests/jarvis_live/test_jarvis_live_model_profile_registry_smoke.py",),
        download_allowed=False,
        runtime_allowed=False,
        voice_allowed=False,
        pc_control_allowed=False,
    ...
    JarvisLiveRoadmapBatch(
        ...
        expected_files=(
            "MAKSIMAR_CORE_LIB/workers_registry/jarvis_live_worker_role_binding_contract.py",
            "MAKSIMAR_CORE_LIB/workers_registry/jarvis_live_worker_alias_binding_contract.py",
            "tests/jarvis_live/test_jarvis_live_worker_identity_binding_smoke.py",
        ),
        target_tests=("tests/jarvis_live/test_jarvis_live_worker_identity_binding_smoke.py",),
        download_allowed=False,
        runtime_allowed=False,
        voice_allowed=False,
        pc_control_allowed=False,
    ...
    JarvisLiveRoadmapBatch(
        ...
        expected_files=(
            "MAKSIMAR_CORE_LIB/memory_engine/storage_registry/jarvis_live_runtime_storage_boundary_contract.py",
            "MAKSIMAR_CORE_LIB/memory_engine/storage_registry/jarvis_live_model_asset_boundary_contract.py",
            "tests/jarvis_live/test_jarvis_live_runtime_storage_boundary_smoke.py",
        ),
        target_tests=("tests/jarvis_live/test_jarvis_live_runtime_storage_boundary_smoke.py",),
        download_allowed=False,
        runtime_allowed=False,
        voice_allowed=False,
        pc_control_allowed=False,
    ...
    JarvisLiveRoadmapBatch(
        ...
        expected_files=(
            ...
            "MAKSIMAR_CORE_LIB/oob_dashboard/jarvis_live_voice_status_panel_contract.py",
            "tests/jarvis_live/test_jarvis_live_voice_status_disabled_smoke.py",
        ),
        target_tests=("tests/jarvis_live/test_jarvis_live_voice_status_disabled_smoke.py",),
        download_allowed=False,
        runtime_allowed=False,
        voice_allowed=False,
        pc_control_allowed=False,
    ...
    JarvisLiveRoadmapBatch(
        ...
        expected_files=(
            "MAKSIMAR_CORE_LIB/mobile_screen_observer/jarvis_live_screen_vision_candidate_contract.py",
            "MAKSIMAR_SERVER/MOBILE_SCREEN_OBSERVER_RUNTIME/jarvis_live_screen_status_read_model.py",
            "tests/jarvis_live/test_jarvis_live_screen_vision_candidate_smoke.py",
        ),
        target_tests=("tests/jarvis_live/test_jarvis_live_screen_vision_candidate_smoke.py",),
        download_allowed=False,
        runtime_allowed=False,
        voice_allowed=False,
        pc_control_allowed=False,
    ...
    JarvisLiveRoadmapBatch(
        ...
        expected_files=(
            "MAKSIMAR_CORE_LIB/security_layer/jarvis_live_action_allowlist_contract.py",
            "MAKSIMAR_CORE_LIB/security_layer/jarvis_live_command_security_binding_contract.py",
            "tests/jarvis_live/test_jarvis_live_action_allowlist_binding_smoke.py",
        ),
        target_tests=("tests/jarvis_live/test_jarvis_live_action_allowlist_binding_smoke.py",),
        download_allowed=False,
        runtime_allowed=False,
        voice_allowed=False,
        pc_control_allowed=False,
    ...
    JarvisLiveRoadmapBatch(
        ...
        expected_files=(
            ...
            "tests/jarvis_live/test_jarvis_live_dashboard_observability_smoke.py",
        ),
        target_tests=("tests/jarvis_live/test_jarvis_live_dashboard_observability_smoke.py",),
        download_allowed=False,
        runtime_allowed=False,
        voice_allowed=False,
        pc_control_allowed=False,
    ...
    JarvisLiveRoadmapBatch(
        ...
        expected_files=(
            "MAKSIMAR_CORE_LIB/ai_orchestration/jarvis_live_external_task_broker_contract.py",
            "MAKSIMAR_SERVER/PROPOSAL_AUDIT/jarvis_live_external_task_broker_audit_binding.py",
            "tests/jarvis_live/test_jarvis_live_external_task_broker_contract_smoke.py",
        ),
        target_tests=("tests/jarvis_live/test_jarvis_live_external_task_broker_contract_smoke.py",),
        download_allowed=False,
        runtime_allowed=False,
        voice_allowed=False,
        pc_control_allowed=False,
    ...
    JarvisLiveRoadmapBatch(
        ...
        expected_files=(
            "MAKSIMAR_SERVER/AI_ORCHESTRATION/jarvis_live_vendor_boundary_contract.py",
            "MAKSIMAR_SERVER/AI_ORCHESTRATION/jarvis_live_model_download_gate_contract.py",
            "tests/jarvis_live/test_jarvis_live_vendor_download_gate_smoke.py",
        ),
        target_tests=("tests/jarvis_live/test_jarvis_live_vendor_download_gate_smoke.py",),
