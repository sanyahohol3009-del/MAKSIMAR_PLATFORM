...
from ANDROID_SHELL.local_ai_runtime.android_local_ai_adapter_contract import (
    build_android_local_ai_adapter_contract,
)


def test_android_local_ai_adapter_contract_is_capability_only() -> None:
    read_model = build_android_local_ai_adapter_contract().to_read_model()
