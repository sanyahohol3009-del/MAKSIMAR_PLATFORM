...
def test_android_child_device_profile_bridge_smoke() -> None:
    bridge = AndroidChildDeviceProfileBridge.default(
...
def test_android_child_device_profile_bridge_rejects_platform_api_call() -> None:
