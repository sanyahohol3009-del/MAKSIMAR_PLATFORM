...
def test_android_guardian_authority_bridge_smoke() -> None:
    bridge = AndroidGuardianAuthorityBridge(
...
def test_android_guardian_authority_bridge_rejects_wrong_scope() -> None:
