...
def test_ios_child_app_control_policy_bridge_smoke() -> None:
    bridge = IOSChildAppControlPolicyBridge(
    ...
    assert contract.policy_id == "ios_child_app_policy_001"
...
def test_ios_child_app_control_policy_bridge_rejects_app_control_runtime() -> None:
