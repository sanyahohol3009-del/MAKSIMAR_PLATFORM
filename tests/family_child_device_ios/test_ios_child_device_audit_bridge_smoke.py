...
def test_ios_child_device_audit_bridge_smoke() -> None:
    bridge = IOSChildDeviceAuditBridge(
    ...
    assert contract.audit_event_id == "ios_child_audit_001"
...
def test_ios_child_device_audit_bridge_rejects_pixel_payload() -> None:
