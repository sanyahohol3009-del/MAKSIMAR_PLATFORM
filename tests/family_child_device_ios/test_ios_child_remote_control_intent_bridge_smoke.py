...
def test_ios_child_remote_control_intent_bridge_smoke() -> None:
    bridge = IOSChildRemoteControlIntentBridge(
    ...
    assert contract.intent_id == "ios_child_remote_intent_001"
...
def test_ios_child_remote_control_intent_bridge_rejects_runtime_execution() -> None:
