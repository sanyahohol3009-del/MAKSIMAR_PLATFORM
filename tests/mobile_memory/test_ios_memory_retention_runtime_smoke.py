...
from IOS_SHELL.memory_adapter.ios_memory_retention_runtime import IOSMemoryRetentionRuntime


def test_ios_memory_retention_runtime_is_policy_metadata_only() -> None:
    runtime = IOSMemoryRetentionRuntime.default_runtime(
        retention_runtime_id="ios_retention_runtime_001",
...
def test_ios_memory_retention_runtime_rejects_real_purge_execution() -> None:
    base = IOSMemoryRetentionRuntime.default_runtime(
        retention_runtime_id="ios_retention_runtime_001",
        device_id="ios_device_001",
        app_id="maksimar_mobile",
        ios_bundle_id="de.maksimar.mobile",
