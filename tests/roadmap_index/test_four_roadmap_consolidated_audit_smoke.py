...
def test_roadmap_next_step_report_smoke() -> None:
    ...
    if report.get("regulatory_step_7_acceptance_exists") is True:
        assert report["current_closed_phase"] == "REGULATORY_MEMORY_FOUNDATION_STEP_7"
        assert report["next_step"] == "STEP 8 — Regulatory Routing / No Cross-Tenant Leak"
        ...
        assert report["current_closed_phase"] == "REGULATORY_MEMORY_FOUNDATION_STEP_4"
        assert report["next_step"] == "STEP 5 — Regulatory Conflict / Drift / Supersession"
