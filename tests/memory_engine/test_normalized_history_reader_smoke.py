...
def test_normalized_history_reader_smoke() -> None:
    segment = build_segment(
        parent_document_id="HDOC-0003",
        source_type="html",
    ...
    record = build_normalized_history_record(segment, 2)
    payload = build_normalized_history_read_payload(record)

    assert payload["memory_id"] == "HCHAT-0002"
