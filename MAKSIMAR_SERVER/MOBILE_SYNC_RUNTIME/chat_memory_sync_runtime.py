...
class ChatMemorySyncDecision:
    ...
    def __post_init__(self) -> None:
        ...
        if self.envelope.memory_domain != "chat_memory":
            raise ValueError("chat memory runtime accepts only chat_memory envelopes")
        if self.cursor.memory_domain != "chat_memory":
            raise ValueError("chat memory runtime requires chat_memory cursor")
        ...
        if not self.policy.allows_domain("chat_memory"):
            raise ValueError("policy must allow chat_memory domain")
...
class ChatMemorySyncRuntime:
    ...
    @classmethod
    def default(cls, *, runtime_id: str, policy: MobileSyncPolicy) -> "ChatMemorySyncRuntime":
        return cls(
    ...
    def evaluate(
        ...
        *,
        ...
        return ChatMemorySyncDecision(
            ...
            decision_reason="chat_memory_envelope_validated_against_policy_and_cursor",
