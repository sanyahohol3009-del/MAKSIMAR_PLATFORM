...
class MediaPipeAndroidAdapterContract:
    contract_id: str
    adapter_kind: str
...
def build_mediapipe_android_adapter_contract() -> MediaPipeAndroidAdapterContract:
    return MediaPipeAndroidAdapterContract(
