...
class AndroidModelRuntimeStatus:
    status_id: str
    platform: str
...
def build_android_model_runtime_status() -> AndroidModelRuntimeStatus:
    return AndroidModelRuntimeStatus(
        status_id="android_model_runtime_status_v0_1",
        platform="android",
