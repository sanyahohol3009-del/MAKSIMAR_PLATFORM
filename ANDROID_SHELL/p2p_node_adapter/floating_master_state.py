...
class AndroidFloatingMasterState:
    """Android shell projection of floating-master state.
    ...
    def __post_init__(self) -> None:
        if self.schema_version != "android_floating_master_state.v1":
            raise ValueError("schema_version must be android_floating_master_state.v1")
        if self.state_id != "android_floating_master_state_disabled_default":
            raise ValueError("state_id must be android_floating_master_state_disabled_default")
        ...
        if self.local_candidate_role != "android_node":
            raise ValueError("local_candidate_role must be android_node")
...
def build_android_floating_master_state(server_present: bool = True) -> AndroidFloatingMasterState:
    return AndroidFloatingMasterState(
        schema_version="android_floating_master_state.v1",
        state_id="android_floating_master_state_disabled_default",
        platform="android",
        ...
        local_candidate_role="android_node",
        ...
        reason_codes=("android_floating_master_state_candidate_visible_no_execution",),
    )
