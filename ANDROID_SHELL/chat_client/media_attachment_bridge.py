...
class AndroidMediaAttachmentBridgeContract:
    """Android media attachment bridge.

    Contract only. It does not render media, generate thumbnails, decode binary
    payloads, upload/download media, or call Android media APIs.
    """
    ...
    android_media_api_call_allowed: bool
    ...
    def __post_init__(self) -> None:
        ...
        if self.android_media_api_call_allowed:
            raise ValueError("android_media_api_call_allowed must be False")
