...
_REF_PREFIXES = ("android-local://", "android-secure-ref://", "secure-ref://", "ref://")
...
class AndroidAppMemoryStoreAdapter:
    adapter_id: str
    ...
    def default_adapter(
        ...
        *,
        ...
        return cls(
            ...
            storage_backend_ref=f"android-local://{device_id}/app-memory/store",
            secure_local_store_ref=f"android-secure-ref://{device_id}/app-memory/secure-store",
