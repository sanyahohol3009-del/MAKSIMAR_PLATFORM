...
_REF_PREFIXES = ("ref://", "android-local://", "android-secure-ref://")
...
class AndroidMemoryStateBridge:
    bridge_id: str
    device_id: str
    app_id: str
    ...
    def from_store_adapter(
        ...
        *,
        bridge_id: str,
        store_adapter: AndroidAppMemoryStoreAdapter,
        record_count: int,
        last_audit_ref: str,
    ) -> "AndroidMemoryStateBridge":
        if not isinstance(store_adapter, AndroidAppMemoryStoreAdapter):
            raise ValueError("store_adapter must be AndroidAppMemoryStoreAdapter")
        return cls(
            bridge_id=bridge_id,
            device_id=store_adapter.device_id,
            app_id=store_adapter.app_id,
            android_package_name=store_adapter.android_package_name,
