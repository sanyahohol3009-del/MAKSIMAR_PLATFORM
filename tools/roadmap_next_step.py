...
def build_next_step_report() -> dict[str, object]:
    ...
    if regulatory_step_9_closed:
        ...
        why = "Regulatory Update Approval Gate is present; next step gates regulatory routing and prevents cross-tenant leaks."
        required_first = [
            "regulatory memory routing models",
            "regulatory retrieval scope gate",
            "cross tenant leak guard",
            "regulatory routing preview",
            "no cross-tenant regulatory retrieval",
        ]
        do_not_start_yet = [
            "Final Closure",
        ]
    elif regulatory_step_6_closed:
        current_closed_phase = "REGULATORY_MEMORY_FOUNDATION_STEP_6"
        next_step = "STEP 7 — Regulatory Update Approval Gate"
        next_folder = "MAKSIMAR_SERVER/REGULATORY_MEMORY_FOUNDATION/"
        why = "Compliance Evidence Pack / Audit Read Model is present; next step gates regulatory updates through approval."
        required_first = [
            "regulatory update approval models",
            "regulatory update approval gate",
            "regulatory update diff builder",
            "regulatory update preview",
            "no regulatory update without approval",
        ]
        do_not_start_yet = [
        ...
        next_folder = "MAKSIMAR_SERVER/REGULATORY_MEMORY_FOUNDATION/"
        why = "Source Version / Effective Date / Precedence is present; next step detects regulatory conflicts, drift and supersession."
        required_first = [
            "regulatory conflict models",
            "regulatory drift detector",
            "regulatory supersession models",
            "regulatory conflict preview",
            "no automatic legal truth resolution",
        ]
        do_not_start_yet = [
            "Compliance Evidence Pack / Audit Read Model",
            "Regulatory Update Approval Gate",
            "Final Closure",
        ]
