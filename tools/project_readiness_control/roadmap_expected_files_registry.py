...
ROADMAP_EXPECTED_BATCHES: tuple[RoadmapExpectedBatch, ...] = (
 ...
 RoadmapExpectedBatch(
  batch_id="6.0",
  title="PHASE 6 Registry Reconciliation / Mobile Local Workflow Correction",
  expected_files=(
   ExpectedProjectFile(path="docs/architecture/workflow_engine/phase_6_workflow_automation_registry_reconciliation_v1.md", role="doc", description="PHASE 6 workflow automation registry reconciliation document."),
   ExpectedProjectFile(path="docs/architecture/workflow_engine/phase_6_mobile_local_workflow_semantic_decision_v1.md", role="doc", description="PHASE 6 mobile local workflow semantic decision document."),
   ExpectedProjectFile(path="tests/workflow_engine/test_phase_6_registry_reconciliation_smoke.py", role="test", description="PHASE 6 registry reconciliation smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_phase_6_mobile_local_workflow_semantic_decision_smoke.py", role="test", description="PHASE 6 mobile local workflow semantic decision smoke test."),
  ),
 ),
 RoadmapExpectedBatch(
  batch_id="6.1",
  title="Workflow Graph Contracts",
  expected_files=(
   ExpectedProjectFile(path="MAKSIMAR_CORE_LIB/workflow_engine/workflow_graph_contract.py", role="source", description="Workflow graph contract extending existing workflow engine."),
   ExpectedProjectFile(path="MAKSIMAR_CORE_LIB/workflow_engine/workflow_node_contract.py", role="source", description="Workflow node contract with n8n-compatible graph semantics."),
   ExpectedProjectFile(path="MAKSIMAR_CORE_LIB/workflow_engine/workflow_edge_contract.py", role="source", description="Workflow edge contract with n8n-compatible graph semantics."),
   ExpectedProjectFile(path="MAKSIMAR_CORE_LIB/workflow_engine/local_workflow_scope_contract.py", role="source", description="Local workflow scope contract for local-first JARVIS mobile node semantics."),
   ExpectedProjectFile(path="MAKSIMAR_CORE_LIB/workflow_engine/n8n_graph_compatibility_contract.py", role="source", description="n8n graph compatibility contract; n8n remains external server adapter/container/runtime."),
   ExpectedProjectFile(path="tests/workflow_engine/test_workflow_graph_contract_smoke.py", role="test", description="Workflow graph contract smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_workflow_node_contract_smoke.py", role="test", description="Workflow node contract smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_workflow_edge_contract_smoke.py", role="test", description="Workflow edge contract smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_local_workflow_scope_contract_smoke.py", role="test", description="Local workflow scope contract smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_n8n_graph_compatibility_contract_smoke.py", role="test", description="n8n graph compatibility contract smoke test."),
  ),
 ),
 RoadmapExpectedBatch(
  batch_id="6.2",
  title="Workflow Governance Contracts",
  expected_files=(
   ExpectedProjectFile(path="MAKSIMAR_CORE_LIB/workflow_engine/local_ai_workflow_proposal_contract.py", role="source", description="Local AI workflow proposal contract; proposal is not execution authority."),
   ExpectedProjectFile(path="MAKSIMAR_CORE_LIB/workflow_engine/mobile_workflow_permission_profile.py", role="source", description="Mobile workflow permission profile contract requiring explicit permission and approval."),
   ExpectedProjectFile(path="MAKSIMAR_CORE_LIB/workflow_engine/workflow_approval_gate_contract.py", role="source", description="Workflow approval gate contract blocking direct phone control without explicit approval."),
   ExpectedProjectFile(path="MAKSIMAR_CORE_LIB/workflow_engine/workflow_audit_contract.py", role="source", description="Workflow audit contract for local and server workflow visibility."),
   ExpectedProjectFile(path="MAKSIMAR_CORE_LIB/workflow_engine/workflow_safety_policy_contract.py", role="source", description="Workflow safety policy contract blocking hidden remote control and direct core/server canonical write."),
   ExpectedProjectFile(path="tests/workflow_engine/test_local_ai_workflow_proposal_contract_smoke.py", role="test", description="Local AI workflow proposal contract smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_mobile_workflow_permission_profile_smoke.py", role="test", description="Mobile workflow permission profile smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_workflow_approval_gate_contract_smoke.py", role="test", description="Workflow approval gate contract smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_workflow_audit_contract_smoke.py", role="test", description="Workflow audit contract smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_workflow_safety_policy_contract_smoke.py", role="test", description="Workflow safety policy contract smoke test."),
  ),
 ),
 RoadmapExpectedBatch(
  batch_id="6.3",
  title="Server Workflow Runtime / n8n Adapter Boundary",
  expected_files=(
   ExpectedProjectFile(path="MAKSIMAR_SERVER/WORKFLOW_AUTOMATION_RUNTIME/__init__.py", role="source", description="Server workflow automation runtime package."),
   ExpectedProjectFile(path="MAKSIMAR_SERVER/WORKFLOW_AUTOMATION_RUNTIME/n8n_adapter_contract.py", role="source", description="n8n adapter boundary contract; n8n is external server adapter/container/runtime."),
   ExpectedProjectFile(path="MAKSIMAR_SERVER/WORKFLOW_AUTOMATION_RUNTIME/workflow_runtime_policy.py", role="source", description="Workflow runtime policy contract for server optional senior/accelerator hub."),
   ExpectedProjectFile(path="MAKSIMAR_SERVER/WORKFLOW_AUTOMATION_RUNTIME/workflow_execution_intent_runtime.py", role="source", description="Workflow execution intent runtime with approval-gated intent only."),
   ExpectedProjectFile(path="MAKSIMAR_SERVER/WORKFLOW_AUTOMATION_RUNTIME/n8n_vendor_gate_runtime.py", role="source", description="n8n vendor gate runtime for OSS download/install approval and sandbox boundary."),
   ExpectedProjectFile(path="tests/workflow_engine/test_n8n_adapter_contract_smoke.py", role="test", description="n8n adapter boundary contract smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_workflow_runtime_policy_smoke.py", role="test", description="Workflow runtime policy smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_workflow_execution_intent_runtime_smoke.py", role="test", description="Workflow execution intent runtime smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_n8n_vendor_gate_runtime_smoke.py", role="test", description="n8n vendor gate runtime smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_n8n_download_requires_vendor_gate_smoke.py", role="test", description="n8n download/install requires vendor gate and sandbox boundary smoke test."),
  ),
 ),
 RoadmapExpectedBatch(
  batch_id="6.4",
  title="Android/iOS Mobile Local Workflow Engine Boundary",
  expected_files=(
   ExpectedProjectFile(path="ANDROID_SHELL/workflow_adapter/android_local_workflow_intent_client.py", role="source", description="Android local workflow intent client with explicit permission/approval boundary."),
   ExpectedProjectFile(path="ANDROID_SHELL/workflow_adapter/android_workflow_permission_bridge.py", role="source", description="Android workflow permission bridge with Android capability profile."),
   ExpectedProjectFile(path="ANDROID_SHELL/workflow_adapter/android_workflow_capability_limits.py", role="source", description="Android workflow capability limits contract."),
   ExpectedProjectFile(path="IOS_SHELL/workflow_adapter/ios_local_workflow_intent_client.py", role="source", description="iOS local workflow intent client with explicit permission/approval boundary."),
   ExpectedProjectFile(path="IOS_SHELL/workflow_adapter/ios_workflow_permission_bridge.py", role="source", description="iOS workflow permission bridge with iOS capability profile."),
   ExpectedProjectFile(path="IOS_SHELL/workflow_adapter/ios_workflow_capability_limits.py", role="source", description="iOS workflow capability limits contract."),
   ExpectedProjectFile(path="tests/workflow_engine/test_android_local_workflow_intent_client_smoke.py", role="test", description="Android local workflow intent client smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_android_workflow_permission_bridge_smoke.py", role="test", description="Android workflow permission bridge smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_ios_local_workflow_intent_client_smoke.py", role="test", description="iOS local workflow intent client smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_ios_workflow_permission_bridge_smoke.py", role="test", description="iOS workflow permission bridge smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_mobile_workflow_rejects_hidden_remote_control_smoke.py", role="test", description="Mobile workflow rejects hidden remote control smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_mobile_workflow_requires_explicit_permission_smoke.py", role="test", description="Mobile workflow requires explicit permission and approval smoke test."),
  ),
 ),
 RoadmapExpectedBatch(
  batch_id="6.5",
  title="Workflow Dashboard / Preview / Container Contract",
  expected_files=(
   ExpectedProjectFile(path="MAKSIMAR_CORE_LIB/workflow_engine/workflow_status_bridge.py", role="source", description="Workflow status bridge read model for dashboard/preview."),
   ExpectedProjectFile(path="tools/workflow_status_preview.py", role="tool", description="Workflow status preview tool; dashboard/preview read-only."),
   ExpectedProjectFile(path="CONTAINER_DEPLOYMENT/cubes/workflow_automation/container_contract.yaml", role="config", description="Workflow automation container contract."),
   ExpectedProjectFile(path="CONTAINER_DEPLOYMENT/cubes/workflow_automation/runtime_profile.yaml", role="config", description="Workflow automation runtime profile."),
   ExpectedProjectFile(path="CONTAINER_DEPLOYMENT/cubes/workflow_automation/network_policy.yaml", role="config", description="Workflow automation network policy with no network/socket/tunnel by default."),
   ExpectedProjectFile(path="tests/workflow_engine/test_workflow_status_bridge_smoke.py", role="test", description="Workflow status bridge smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_workflow_status_preview_smoke.py", role="test", description="Workflow status preview smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_workflow_dashboard_read_only_smoke.py", role="test", description="Workflow dashboard read-only smoke test."),
   ExpectedProjectFile(path="tests/container_readiness/test_workflow_automation_container_contract_smoke.py", role="test", description="Workflow automation container contract smoke test."),
   ExpectedProjectFile(path="tests/container_readiness/test_workflow_automation_network_policy_smoke.py", role="test", description="Workflow automation network policy smoke test."),
  ),
 ),
 RoadmapExpectedBatch(
  batch_id="6.6",
  ...
  expected_files=(
   ExpectedProjectFile(path="docs/architecture/workflow_engine/phase_6_workflow_automation_acceptance_v1.md", role="doc", description="PHASE 6 workflow automation acceptance document."),
   ExpectedProjectFile(path="tests/workflow_engine/test_phase_6_workflow_engine_acceptance_smoke.py", role="test", description="PHASE 6 workflow engine acceptance smoke test."),
   ExpectedProjectFile(path="tests/workflow_engine/test_phase_6_mobile_local_workflow_acceptance_smoke.py", role="test", description="PHASE 6 mobile local workflow acceptance smoke test."),
