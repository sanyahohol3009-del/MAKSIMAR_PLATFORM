...
ROADMAP_EXPECTED_BATCHES: tuple[RoadmapExpectedBatch, ...] = (
 ...
 RoadmapExpectedBatch(
  batch_id="4.2",
  title="Screen Policy / Remote Assistance Contracts",
  expected_files=(
 ...
 RoadmapExpectedBatch(
  batch_id="4.3",
  title="Server Screen Observer Runtime",
  expected_files=(
 ...
 RoadmapExpectedBatch(
  batch_id="4.4",
  title="Android Screen Observer Client",
  expected_files=(
 ...
 RoadmapExpectedBatch(
  batch_id="4.5",
  title="iOS Screen Observer Client",
  expected_files=(
