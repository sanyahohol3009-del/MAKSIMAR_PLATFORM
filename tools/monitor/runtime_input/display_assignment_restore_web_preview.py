...
from MAKSIMAR_CORE_LIB.oob_dashboard.display_assignment_restore_contract import (  # noqa: E402
...
def main() -> None:
    ...
    payload = {
        ...
        "direct_restore_entries": contract.direct_restore_entries,
        "shared_surface_restore_entries": contract.shared_surface_restore_entries,
        ...
        "entries": [
            {
                ...
                "restore_decision": entry.restore_decision,
                "restore_state": entry.restore_state,
    ...
    print("<!doctype html>")
    print("<html><head><meta charset='utf-8'><title>Display Assignment Restore</title></head><body>")
    print("<h1>Display Assignment Restore</h1>")
