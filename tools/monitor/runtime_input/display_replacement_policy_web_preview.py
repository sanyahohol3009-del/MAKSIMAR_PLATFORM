...
def main() -> None:
    ...
    payload = {
        ...
        "not_replaceable_entries": contract.not_replaceable_entries,
        ...
        "entries": [
            {
                ...
                "replacement_decision": entry.replacement_decision,
                "replacement_class": entry.replacement_class,
    ...
    print("<!doctype html>")
    print("<html><head><meta charset='utf-8'><title>Display Replacement Policy</title></head><body>")
    print("<h1>Display Replacement Policy</h1>")
