...
def main() -> None:
    ...
    payload = {
        ...
        "foundation_visible_entries": contract.foundation_visible_entries,
        "interaction_visible_entries": contract.interaction_visible_entries,
        "operator_visible_entries": contract.operator_visible_entries,
        "truth_bound_entries": contract.truth_bound_entries,
        "entries": [
            {
                "visible_state_id": entry.visible_state_id,
                "display_target_id": entry.display_target_id,
                "workspace_id": entry.workspace_id,
                "visible_state_state": entry.visible_state_state,
                "visible_state_class": entry.visible_state_class,
                "visible_state_mode": entry.visible_state_mode,
    ...
    print("<!doctype html>")
    print("<html><head><meta charset='utf-8'><title>Visible State</title></head><body>")
    print("<h1>Visible State</h1>")
