...
def main() -> None:
    ...
    payload = {
        ...
        "active_entries": contract.active_entries,
    ...
    print("<!doctype html>")
    print("<html><head><meta charset='utf-8'><title>Display Assignment Registry</title></head><body>")
    print("<h1>Display Assignment Registry</h1>")
