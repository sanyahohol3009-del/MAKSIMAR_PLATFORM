...
def main() -> None:
    ...
    payload = {
        ...
        "entries": [
            {
                "workspace_restore_id": entry.workspace_restore_id,
                "workspace_id": entry.workspace_id,
                "workspace_restore_state": entry.workspace_restore_state,
                "workspace_restore_class": entry.workspace_restore_class,
                "workspace_read_model_ready": entry.workspace_read_model_ready,
                "display_assignment_restore_ready": entry.display_assignment_restore_ready,
                "display_restore_continuity_ready": entry.display_restore_continuity_ready,
    ...
    print("<!doctype html>")
    print("<html><head><meta charset='utf-8'><title>Workspace Restore</title></head><body>")
    print("<h1>Workspace Restore</h1>")
