...
def main() -> None:
    ...
    payload = {
        ...
        "shared_surface_entries": contract.shared_surface_entries,
        ...
        "entries": [
            {
                ...
                "snapshot_class": entry.snapshot_class,
                "active_assignments": entry.active_assignments,
                "selected_assignment_present": entry.selected_assignment_present,
    ...
    print("<!doctype html>")
    print("<html><head><meta charset='utf-8'><title>Display Continuity Snapshot</title></head><body>")
    print("<h1>Display Continuity Snapshot</h1>")
