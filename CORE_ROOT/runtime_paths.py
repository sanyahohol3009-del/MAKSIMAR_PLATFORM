...
STOP_GATE_TRIGGER_FILE = RUNTIME_STATE_DIR / "stop_gate_trigger.txt"
DEGRADED_MODE_FILE = RUNTIME_STATE_DIR / "degraded_mode.flag"
LAST_DEGRADED_REASON_FILE = RUNTIME_STATE_DIR / "last_degraded_reason.txt"
