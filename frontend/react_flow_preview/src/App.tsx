      ...
      case "conversation":
        return (
          <div style={{ display: "grid", gap: 10 }}>
            {jarvisChatDrawerFixture.messages.map((message) => (
              <section
      ...
      case "project_context":
        return (
          <section className="inspect-section">
            <h3>{jarvisChatDrawerFixture.projectContextSummary.title}</h3>
            <div className="inspect-fields">
              <div className="inspect-field">
                <span className="inspect-field-key">Active Scope</span>
                <span className="inspect-field-value">
                  {jarvisChatDrawerFixture.projectContextSummary.activeScope}
                </span>
              </div>
              <div className="inspect-field">
                <span className="inspect-field-key">Owner</span>
                <span className="inspect-field-value">
                  {jarvisChatDrawerFixture.projectContextSummary.owner}
                </span>
              </div>
              <div className="inspect-field">
                <span className="inspect-field-key">Updated</span>
                <span className="inspect-field-value">
                  {jarvisChatDrawerFixture.projectContextSummary.lastUpdatedLabel}
                </span>
              </div>
            </div>

            <div style={{ display: "grid", gap: 8, marginTop: 12 }}>
              {jarvisChatDrawerFixture.projectContextSummary.summaryLines.map(
                (line, index) => (
                  <div
